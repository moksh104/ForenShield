...
final List<ComponentDefinition> cardComponents = [
  ComponentDefinition(
    ...
    purpose:
        'Acts as the foundational surface for most grouped content in ForenShield.',
    whenToUse: 'To group related information visually.',
    whenNotToUse:
        'When the content is extremely simple and does not require separation from the background.',
  ...
  body: Text('Main card content goes here.'),
    ...
    properties: [
      ...
      const ComponentProperty(
        name: 'subtitle',
        type: PropertyType.string,
        defaultValue: 'Collected on Oct 24, 2026',
      ),
      const ComponentProperty(
        name: 'elevation',
    ...
    builder: (context, props) {
      return AppCard(
        ...
        body: const Text(
          'This is the main body content of the card. It scales automatically based on its children.',
        ),
      );
    },
  ),
  ComponentDefinition(
    ...
    whenToUse:
        'For major sections on a screen containing multiple smaller elements or cards.',
  ...
  child: ActivityListWidget(),
    ...
    properties: [
      const ComponentProperty(
        name: 'title',
        type: PropertyType.string,
        defaultValue: 'Investigation Progress',
      ),
      const ComponentProperty(
        name: 'subtitle',
        type: PropertyType.string,
        defaultValue: 'View all your recent module scores.',
      ),
    ],
    builder: (context, props) {
      return SectionCard(
  ...
  ComponentDefinition(
    ...
    purpose:
        'Used for overlapping UI elements to maintain context of what is behind them.',
    whenToUse:
        'For premium overlays, floating action panels, or complex backgrounds.',
    whenNotToUse:
        'As a generic list item container due to performance overhead.',
    performanceNotes:
        'Extensive use of BackdropFilter can cause GPU frame drops on lower-end devices. Use sparingly.',
  ...
  ComponentDefinition(
    ...
    whenToUse:
        'For success messages, warnings, critical errors, or important tips.',
  ...
  description: 'Operating in offline mode.',
    ...
    properties: [
      const ComponentProperty(
        ...
        defaultValue: InfoCardType.info,
        options: InfoCardType.values,
      ),
      const ComponentProperty(
        name: 'title',
        type: PropertyType.string,
