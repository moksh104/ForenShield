...
final List<ComponentDefinition> buttonComponents = [
  ComponentDefinition(
    ...
    purpose:
        'Provides a standard interaction surface for primary, secondary, tertiary, and destructive actions.',
    whenToUse:
        'Whenever a user needs to trigger an action, submit a form, or navigate.',
  ...
  onPressed: () {},
    ...
    properties: [
      ...
      const ComponentProperty(
        ...
        defaultValue: AppButtonType.primary,
        options: AppButtonType.values,
      ),
      const ComponentProperty(
        name: 'isLoading',
