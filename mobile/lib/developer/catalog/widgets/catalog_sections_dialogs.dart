...
class DialogsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CatalogSection(
      title: 'Dialogs',
      description:
          'Mission Brief, Investigation Summary, Success, Warning (standard & destructive).',
      child: Column(
                ...
                ForenButton.primary(
                  ...
                  onPressed: () => showDialog(
                    ...
                    builder: (_) => ForenSuccessDialog(
                      ...
                      message:
                          'You successfully identified all indicators of compromise in the Finance phishing case.',
                ...
                ForenButton.ghost(
                  ...
                  onPressed: () => showDialog(
                    ...
                    builder: (_) => ForenWarningDialog(
                      ...
                      message:
                          'Your progress will be saved, but your current run will end. You can resume this mission from the beginning.',
                ...
                ForenButton.danger(
                  ...
                  onPressed: () => showDialog(
                    ...
                    builder: (_) => ForenWarningDialog(
                      ...
                      message:
                          'This will permanently delete CASE-2024-0041 and all associated evidence. This action cannot be undone.',
