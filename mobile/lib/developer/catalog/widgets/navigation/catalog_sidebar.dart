    ...
    return SizedBox(
      ...
      child: Material(
        ...
        child: ListView(
          ...
          const Divider(),
          ListTile(
            title: Text('All Components', style: activeCategory == null ? theme.textTheme.labelLarge?.copyWith(color: primaryColor) : theme.textTheme.labelLarge),
          ...
          ...categories.map((cat) {
            ...
            return ListTile(
              title: Text(cat, style: isSelected ? theme.textTheme.labelLarge?.copyWith(color: primaryColor) : theme.textTheme.labelLarge),
              selected: isSelected,
              selectedTileColor: primaryColor.withValues(alpha: 0.1),
              onTap: () {
