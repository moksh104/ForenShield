...
class BadgesSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CatalogSection(
      title: 'Badges & Chips',
      description: 'Threat Badge, Difficulty Badge, Status Chip, XP Chip, Notification Badge.',
      child: Column(
          ...
          CatalogSubsection(
            ...
            child: CatalogPropRow(children: [
              ForenNotificationBadge(
                count: 3,
                child: const Icon(Icons.notifications_outlined, size: ForenIconSize.hero),
              ),
              ForenNotificationBadge(
                count: 128,
                child: const Icon(Icons.mail_outline, size: ForenIconSize.hero),
              ),
              ForenNotificationBadge(
                count: 0,
                child: const Icon(Icons.shield_outlined, size: ForenIconSize.hero),
              ),
            ]),
          ),
        ],
