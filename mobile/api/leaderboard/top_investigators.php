...
$sort = strtolower(trim($_GET['sort'] ?? 'investigations'));
...
$orderCol = 'sub.investigations_completed';
if ($sort === 'rank') $orderCol = 'sub.rnk';
elseif ($sort === 'xp') $orderCol = 'sub.total_xp';
    ...
    $sql = "
        WITH RankedUsers AS (
            SELECT 
                ...
                l.courses_completed,
                l.reports_completed,
                RANK() OVER (ORDER BY l.investigations_completed DESC) as rnk
